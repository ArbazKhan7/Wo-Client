...
const Navbar =()=>{
  ...
  <div className="container-fluid">
    <NavLink   className="navbar-brand" to="/">WoClient</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink  activeClassName='menu_active' className="nav-link active " aria-current="page" to="/login">Login</NavLink>
        </li>
